...
const featuredItems = MyPortfolio.MENU.filter((project) =>
...
const SectionProjects = () => {
  ...
  return (
    <section id="projects" className="section-projects">
      <Container className="section-projects__container">
        <h2 className="section-projects__title">{t('projects.title')}</h2>
